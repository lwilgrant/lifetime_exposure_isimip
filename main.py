...
# #%% ----------------------------------------------------------------
# # getting new df_GMT_strj using existing 1.5 and 3.5 with adjustments (perfect increments at 2100)
# # once I get bounds, round their final year to 1.5 and 3.5, then do interp
